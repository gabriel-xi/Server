...
router.post('/request', async (req, res) => {
    ...
    try {
        ...
        const duplicateCheck = await db.query(
            'SELECT * FROM FriendRequests WHERE (sender_id = $1 AND receiver_id = $2) OR (sender_id = $2 AND receiver_id = $1)',
        ...
        await db.query(
            'INSERT INTO FriendRequests (sender_id, receiver_id, status) VALUES ($1, $2, \'pending\')',
            [sender_id, receiver_id]
        );
